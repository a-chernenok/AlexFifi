...
<div class="flex flex-col items-center justify-center h-screen bg-[url('images/background.jpg')] text-center">
    ...
    <p class="text-xl text-gray-600">Youre such a Skatoula!</p>
    <p class="text-xl text-gray-600">But that's okay! Maybe next time!</p>
    <button on:click={() => window.location.href = "/"} class="mt-4 bg-purple-500 text-white py-2 px-4 rounded-lg hover:bg-purple-700 transition duration-300">
        Go Back
    </button>
</div>